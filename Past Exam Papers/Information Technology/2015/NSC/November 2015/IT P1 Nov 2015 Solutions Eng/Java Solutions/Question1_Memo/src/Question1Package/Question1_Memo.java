    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(btnQues1_5, javax.swing.GroupLayout.PREFERRED_SIZE, 119, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(10, 10, 10)
        ...
        jPanel9Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel9Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(btnQues1_4, javax.swing.GroupLayout.PREFERRED_SIZE, 111, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    private void btnQues1_2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnQues1_2ActionPerformed
        ...
        if (startWeight > goalWeight) {
            ...
            while (goalWeight < startWeight) {
                numDays++;
                startWeight -= 0.375;
                txaOutput_1_2.append(numDays + "\t" + String.format("%6.3f",startWeight) + "\n");
            }
        } else {
...
// Question 1.3
    private void btnQues1_3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnQues1_3ActionPerformed
        ...
        // membershipCode = membershipCode.replaceAll("[AEIOU ]", "");
        ...
        membershipCode = membershipCode +  randNum + (randNum + 10 + numChar);
...
// Question 1.5
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Question1_Memo.class
